...
namespace clinic_db
{
    public partial class PatientList : UserControl
    {
        ...
        public void LoadEntries()
        {
            ...
            {
                LinkLabel lb = new LinkLabel(); lb.Text = patients[i].Name; lb.Show();
                lb.Click += lb_Click;
                Label lb1 = new Label(); lb1.Text = patients[i].Age.ToString(); lb1.Show();
                Label lb2 = new Label(); lb2.Text = patients[i].Address; lb2.Show();
